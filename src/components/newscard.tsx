...
export const NewsCard: FC<NewsCardProps> = (props) => {
  ...
  return (
      <Card className="flex max-h-85 min-h-70 max-w-84 min-w-74 flex-col !rounded-xl shadow-md hover:drop-shadow-lg lg:!rounded-2xl transition-all duration-300 cursor-pointer">
