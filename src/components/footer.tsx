...
export const Footer = () => {
    ...
    return (
        <div className="bg-primary01 text-white px-6 md:px-12 py-8">
            <div className="flex flex-col lg:flex-row flex-wrap gap-4">
                {/* Section 1: Logo + Contact */}
                <div className="w-full lg:flex-1 flex flex-col md:flex-row items-start">
                    <div className="flex flex-col gap-4 min-w-[120px] pb-5">
                    ...
                    <div className="w-full md:flex-1">
                        ...
                        <h5 className="text-neutral01 leading-relaxed whitespace-nowrap">
                            ...
                            โทรศัพท์ 02 470 8822, 02 470 9585<br />
                            โทรสาร 02 428 4025
                        </h5>
                    </div>
                </div>
